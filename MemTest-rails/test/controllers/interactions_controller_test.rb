...
class InteractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interaction" do
    assert_difference('Interaction.count') do
      post interactions_url, params: { interaction: { prompt_time: @interaction.prompt_time, question_id: @interaction.question_id, response: @interaction.response, thinking_milis: @interaction.thinking_milis } }
    end
  ...
  test "should update interaction" do
    patch interaction_url(@interaction), params: { interaction: { prompt_time: @interaction.prompt_time, question_id: @interaction.question_id, response: @interaction.response, thinking_milis: @interaction.thinking_milis } }
