...
class AssociationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create association" do
    assert_difference('Association.count') do
      post associations_url, params: { association: { content: @association.content, label: @association.label } }
    end
  ...
  test "should update association" do
    patch association_url(@association), params: { association: { content: @association.content, label: @association.label } }
